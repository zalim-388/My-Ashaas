...
Widget buildFindyouTitle(String title) {
  return Text(
    title,
...
Widget buildBgCardTitle({
  ...
  return Row(
    children: [
      Icon(icon, color: kPrimaryColor, size: isLandscape ? 16.sp : 24.sp),
      SizedBox(width: 8.w),
      Text(
        title ?? "",
...
Widget buildBgCard({required Widget child, required BuildContext context}) {
  final isLandscape =
      MediaQuery.of(context).orientation == Orientation.landscape;
  return Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(color: kPrimaryColor.withOpacity(0.2), width: 1.5.w),
      boxShadow: [
        BoxShadow(
